...
Skip32.prototype.round16 = function(k, n){
	...
	g1 = (n>>8) & 0xff;
	g2 = (n>>0) & 0xff;
	g3 = this.ftable[g2^this.key[(4*k+0)%10]] ^ g1;
	g4 = this.ftable[g3^this.key[(4*k+1)%10]] ^ g2;
	g5 = this.ftable[g4^this.key[(4*k+2)%10]] ^ g3;
	g6 = this.ftable[g5^this.key[(4*k+3)%10]] ^ g4;
	return (g5<<8)+g6;
}
